<template>
  <button
    ...
    :class="[
      'generic-btn',
      !unstyled && 'rounded-xl py-3 px-8 uppercase text-[16px] font-semibold',
  ...
  >
    <slot>
      <span class="inline-svg" :class="[font, 'inline-svg']" v-if="data?.label" v-html="replaceWithSpecialSymbols(data.label)" />
    </slot>
  </button>
</template>
