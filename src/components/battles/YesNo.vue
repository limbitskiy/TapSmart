<template>
  <div class="yes-no-battle flex-1 flex flex-col">
    ...
    <div class="question-cnt flex flex-col flex-1 relative">
      <div
        class="question-content grid grid-rows-[1fr_4fr] flex-1 justify-items-center"
      >
    ...
    <div class="answer-buttons flex gap-4 justify-evenly mt-4">
      <Button
        ...
        @click="() => handleAnswer(task.task.variants[1])"
      >
        <svg
          width="24"
          height="24"
      ...
      <Button
        ...
        @click="() => handleAnswer(task.task.variants[0])"
      >
        <svg
          width="29"
          height="23"
