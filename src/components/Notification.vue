<template>
  <div
    ...
    style="
      background: linear-gradient(103.32deg, #353535 6.07%, #1a1a1a 98.61%);
    "
  >
    <div class="top flex gap-4">
      <div class="icon pt-2 scale-75">
        ...
        >
          ...
          />
          <path
            d="M21.8571 10.3574H24.1428V27.4288H21.8571V10.3574Z"
            fill="#E42A2A"
            stroke="#E42A2A"
          />
          <path
      ...
      <div class="text flex flex-col">
        ...
        <span
          class="fira-condensed text-sm inline-svg svg-top-margin my-1"
          v-html="replaceWithSpecialSymbols(notification.subtitle)"
        ></span>
      </div>
    </div>
    ...
    <div
      ...
      :style="[
        start ? 'transform: scaleX(0)' : null,
        `transition: transform ${notification?.timeout / 1000 || 3}s linear;`,
      ]"
    ></div>
  </div>
</template>
...
//   replaceWithSpecialSymbols(notification.value.subtitle)
// );
