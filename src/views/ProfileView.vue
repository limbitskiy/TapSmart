    ...
    <BackgroundPill>
      ...
      <div class="flex flex-col gap-2 mt-4">
        ...
        <div class="with-substat flex flex-col">
          ...
          <!-- bolts today -->
          <Pill class="!py-0 mx-2 bg-[#2e2e2e] rounded-lg rounded-t-none" :tooltip="locale?.['tooltip_bolts_today']">
            <div class="content flex items-center justify-between">
        ...
        <div class="with-substat flex flex-col">
          ...
          <!-- nuts today -->
          <Pill class="!py-0 mx-2 bg-[#2e2e2e] rounded-lg rounded-t-none" :tooltip="locale?.['tooltip_nuts_today']">
            <div class="content flex items-center justify-between">
        ...
        <div class="with-substat flex flex-col">
          ...
          <!-- bolts left -->
          <Pill class="!py-0 mx-2 bg-[#2e2e2e] rounded-lg rounded-t-none">
            <div class="content flex items-center justify-between">
    ...
    <BackgroundPill>
      ...
      <div class="flex flex-col gap-2 mt-4">
        ...
        <div class="with-substat flex flex-col">
          ...
          <!-- words learned today -->
          <!-- <Pill class="!py-0 mx-2 bg-[#2e2e2e] rounded-xl rounded-t-none">
              <div class="content flex items-center justify-between">
        ...
        <div class="with-substat flex flex-col">
          ...
          <Pill class="!py-0 mx-2 bg-[#2e2e2e] rounded-lg rounded-t-none" :tooltip="locale?.['tooltip_bolts_remain']">
            <div class="content flex items-center justify-between">
