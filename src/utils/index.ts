...
// export const handleEndBattleScreeshots = (data, screenshotArray, leaderboardRef, useFetch, generatingStory) => {
...
//         tg.shareToStory(res.data.url, { widget_link: { url: data.value?.["story_link"], name: data.value?.["story_text"] } });
//       } catch (error) {
//         console.error(error);
